...
This modification will convert 'Studio' to 0 when processing the form data, ensuring that the 'int()' function doesn't encounter an error while trying to convert it to
